...
USER = "q"
PATH_TO_BOT = f"/home/{USER}/p/python/projects/search_lead_category_bot/design"
...
API_ID = int(os.getenv("API_ID_desing"))
API_HASH = os.getenv("API_HASH_design")
...
TABLE_DATA = "data"
TABLE_USERS = 'users_design'
TABLE_USERS_TARIFF_CATEGORY = 'users_tariff_design'
TABLE_APPLICATIONS = "applications_design"
